...
public class HotelController {
    ...
    public String listHotelRooms() {
        ...
        for (Room room : rooms) {
            result.append(String.format("Room %d: %d beds, $%.2f<br>", room.getRoomNumber(), room.getBedCount(),
                room.getRoomPrice()));
        }
        return result.toString();
    }

    @PostMapping("/hotel/addroom")
    ...
    @DeleteMapping("/hotel/deleteroom")
    ...
    @PutMapping("/hotel/changeroom")
    public String changeRoom(@RequestParam int roomNumber, @RequestParam int bedCount, @RequestParam double roomPrice,
        ...
        if (room != null) {
            ...
            return "Room information successfully updated.";
        }
        return "Room not found";
    }
}